...
;Variables a utilizar
 ...
 CONFIG_TMR2:
    ...
    BSF ((T2CON) and 07Fh), 3 ;POSTCALER = 1111 = 1:16
 ...
 CONFIG_TMR1:
    ...
    BSF ((T1CON) and 07Fh), 5 ;CONFIGURACI?N DE PRESCALER
 ...
 CONFIG_INT_ENABLE:
    ...
    BSF ((PIE1) and 07Fh), 0 ;INTERRUPCI?N TMR1
 ...
 CONFIG_TMR0:
    ...
    BCF ((OPTION_REG) and 07Fh), 0 ;Prescaler = 100 = 1:32
    BANKSEL PORTA
    REINICIAR_TMR0
    RETURN
 ...
 CONFIG_RELOJ:
    BANKSEL OSCCON
    BCF ((OSCCON) and 07Fh), 6 ;IRCF = 001 = 125 KHz
